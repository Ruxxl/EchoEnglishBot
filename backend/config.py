...
# Telegram username (без "@") преподавателя — определяет доступ к админке и то, чьи
# сообщения боту считаются новостями/ответами ученикам. Сравнение регистронезависимое.
TEACHER_USERNAME = os.environ.get("TEACHER_USERNAME", "ISNVO")
